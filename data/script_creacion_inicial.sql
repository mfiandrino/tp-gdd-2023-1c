...
CONSTRAINT FK_PEDIDO_CUPON_CUPON_TIPO FOREIGN KEY (TIPO_ID) REFERENCES BASE_DE_GATOS_2.PEDIDO_CUPON_TIPO(ID);
GO
...
CONSTRAINT FK_LOCAL_DIRECCION_LOCALES FOREIGN KEY (DIRECCION_ID) REFERENCES BASE_DE_GATOS_2.DIRECCION(ID);
GO
...
CONSTRAINT FK_REPARTIDOR_TIPO_MOVILIDAD_REPARTIDORES FOREIGN KEY (MOVILIDAD_ID) REFERENCES BASE_DE_GATOS_2.MOVILIDAD(ID);
GO

ALTER TABLE BASE_DE_GATOS_2.MEDIOS_DE_PAGO
ADD CONSTRAINT FK_TIPO_MEDIO_PAGO_MEDIO_PAGO FOREIGN KEY (TIPO_ID) REFERENCES BASE_DE_GATOS_2.TIPO_MEDIO_DE_PAGO(ID),
...
CONSTRAINT FK_DIRECCION_DIRECCION_USUARIO FOREIGN KEY (DIRECCION_ID) REFERENCES BASE_DE_GATOS_2.DIRECCION(ID);
GO

ALTER TABLE BASE_DE_GATOS_2.PEDIDOS
ADD CONSTRAINT FK_ESTADO_PEDIDO_PEDIDOS FOREIGN KEY (ESTADO_ID) REFERENCES BASE_DE_GATOS_2.ESTADO_PEDIDO(ID),
...
CONSTRAINT FK_PEDIDO_DIRECCION FOREIGN KEY (DIRECCION_USUARIO_ID) REFERENCES BASE_DE_GATOS_2.DIRECCION(ID);
GO

ALTER TABLE BASE_DE_GATOS_2.RECLAMOS
ADD CONSTRAINT FK_TIPO_RECLAMO_RECLAMOS FOREIGN KEY (TIPO_ID) REFERENCES BASE_DE_GATOS_2.TIPO_RECLAMO(ID),
CONSTRAINT FK_ESTADO_RECLAMO_RECLAMOS FOREIGN KEY (ESTADO_ID) REFERENCES BASE_DE_GATOS_2.ESTADO_RECLAMO(ID),
CONSTRAINT FK_SOLUCION_RECLAMO_RECLAMOS FOREIGN KEY (SOLUCION_ID) REFERENCES BASE_DE_GATOS_2.SOLUCION_RECLAMO(ID),
...
ADD CONSTRAINT FK_DIR_ORIGEN_ENVIO_MENSAJERIA FOREIGN KEY (DIRECCION_ORIGEN_ID) REFERENCES BASE_DE_GATOS_2.DIRECCION(ID),
CONSTRAINT FK_DIR_DESTINO_ENVIO_MENSAJERIA FOREIGN KEY (DIRECCION_DESTINO_ID) REFERENCES BASE_DE_GATOS_2.DIRECCION(ID),
CONSTRAINT FK_ESTADO_ENVIO_MENSAJERIA FOREIGN KEY (ESTADO_ID) REFERENCES BASE_DE_GATOS_2.ESTADO_ENVIO_MENSAJERIA(ID),
CONSTRAINT FK_USUARIO_ENVIO_MENSAJERIA FOREIGN KEY (USUARIO_ID) REFERENCES BASE_DE_GATOS_2.USUARIOS(ID),
CONSTRAINT FK_TIPO_PAQUETE_ENVIO_MENSAJERIA FOREIGN KEY (TIPO_PAQUETE_ID) REFERENCES BASE_DE_GATOS_2.TIPO_PAQUETES(ID),
...
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_tipos_paquete
	AS
		BEGIN
		INSERT INTO BASE_DE_GATOS_2.TIPO_PAQUETES (TIPO, ALTO_MAX, ANCHO_MAX, LARGO_MAX, PESO_MAX, PRECIO)
			SELECT DISTINCT
				PAQUETE_TIPO,
				PAQUETE_ALTO_MAX,
				PAQUETE_ANCHO_MAX,
...
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_estados_envio_mensajeria
	AS
		BEGIN
		INSERT INTO BASE_DE_GATOS_2.ESTADO_ENVIO_MENSAJERIA(ESTADO)
			SELECT DISTINCT
		...
		INSERT INTO BASE_DE_GATOS_2.LOCALES(NOMBRE, DESCRIPCION, DIRECCION_ID, CATEGORIA_ID)
			...
			FROM 
				gd_esquema.Maestra m
					...
					JOIN BASE_DE_GATOS_2.DIRECCION d ON m.LOCAL_DIRECCION = d.DIRECCION AND d.LOCALIDAD_ID = l.ID
			WHERE 
...
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_movilidades
	AS
		BEGIN
		INSERT INTO BASE_DE_GATOS_2.MOVILIDAD(MOVILIDAD)
			SELECT DISTINCT
		...
		INSERT INTO BASE_DE_GATOS_2.REPARTIDORES(
			...
			SELECT DISTINCT
				...
				(
					SELECT TOP 1 mv.ID
					FROM gd_esquema.Maestra m2
					JOIN BASE_DE_GATOS_2.MOVILIDAD mv
...
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_envio_mensajeria
	AS
		...
		REPARTIDOR_ID, MEDIO_PAGO_ID)
			...
			JOIN BASE_DE_GATOS_2.DIRECCION d2 
...
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_estados_pedido
	AS
		BEGIN
		INSERT INTO BASE_DE_GATOS_2.ESTADO_PEDIDO(ESTADO)
			SELECT DISTINCT
				m.PEDIDO_ESTADO
			FROM 
				gd_esquema.Maestra m
	...
	AS
		...
		INSERT INTO BASE_DE_GATOS_2.PEDIDOS(
			...
			SELECT DISTINCT
				...
				(
					SELECT TOP 1 ep.ID
					FROM BASE_DE_GATOS_2.ESTADO_PEDIDO ep
...
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_tipo_reclamo
	AS
		BEGIN
		INSERT INTO BASE_DE_GATOS_2.TIPO_RECLAMO(TIPO)
			SELECT DISTINCT
				m.RECLAMO_TIPO
			FROM 
				gd_esquema.Maestra m
...
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_estado_reclamo
	AS
		BEGIN
		INSERT INTO BASE_DE_GATOS_2.ESTADO_RECLAMO(ESTADO)
			SELECT DISTINCT
				m.RECLAMO_ESTADO
			FROM 
				gd_esquema.Maestra m
...
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_solucion_reclamo
	AS
		BEGIN
		INSERT INTO BASE_DE_GATOS_2.SOLUCION_RECLAMO(SOLUCION)
			SELECT DISTINCT
				m.RECLAMO_SOLUCION
			FROM 
				gd_esquema.Maestra m
...
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_direcciones
	AS
		BEGIN
		INSERT INTO BASE_DE_GATOS_2.DIRECCION(DIRECCION, LOCALIDAD_ID)
			SELECT DISTINCT 
	...
	AS
		...
		INSERT INTO BASE_DE_GATOS_2.DIRECCION_USUARIO(USUARIO_ID, NOMBRE, DIRECCION_ID)
			...
			FROM gd_esquema.Maestra m
				JOIN BASE_DE_GATOS_2.PROVINCIAS p ON m.DIRECCION_USUARIO_PROVINCIA = p.NOMBRE
				JOIN BASE_DE_GATOS_2.LOCALIDADES l ON m.DIRECCION_USUARIO_LOCALIDAD = l.NOMBRE AND l.PROVINCIA_ID = p.ID
				JOIN BASE_DE_GATOS_2.DIRECCION d ON m.DIRECCION_USUARIO_DIRECCION = d.DIRECCION AND d.LOCALIDAD_ID = l.ID
...
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_pedido_cupon_tipo
	AS
		BEGIN
		INSERT INTO BASE_DE_GATOS_2.PEDIDO_CUPON_TIPO(TIPO)
			SELECT DISTINCT
				m.CUPON_TIPO
			FROM 
				gd_esquema.Maestra m
...
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_pedido_cupon
	AS
		...
		INSERT INTO BASE_DE_GATOS_2.PEDIDO_CUPON(PEDIDO_NUMERO, CUPON_NUMERO, TIPO_ID)
			...
			FROM 
				gd_esquema.Maestra m
			JOIN BASE_DE_GATOS_2.PEDIDO_CUPON_TIPO t ON m.CUPON_TIPO = t.TIPO
			WHERE 
				m.CUPON_NRO IS NOT NULL AND
				m.PEDIDO_NRO IS NOT NULL
		END
...
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_tipo_medio_de_pago
	AS
		BEGIN
		INSERT INTO BASE_DE_GATOS_2.TIPO_MEDIO_DE_PAGO(TIPO)
			SELECT DISTINCT
				m.MEDIO_PAGO_TIPO
			FROM 
				gd_esquema.Maestra m
...
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_medios_de_pago
	AS
		...
		INSERT INTO BASE_DE_GATOS_2.MEDIOS_DE_PAGO(NUMERO_TARJETA, TIPO_ID, MARCA_TARJETA_ID, USUARIO_ID)
			...
			FROM 
				gd_esquema.Maestra m
			JOIN BASE_DE_GATOS_2.TIPO_MEDIO_DE_PAGO tmp ON m.MEDIO_PAGO_TIPO = tmp.TIPO
