...
--ENVIO_MENSAJERIA
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.ENVIO_MENSAJERIA(
...
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.ESTADO_ENVIO_MENSAJERIA (
...
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.TIPO_PAQUETES (
...
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.LOCAL_PRODUCTO (
...
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.LOCAL_PRODUCTO_PEDIDO (
...
-- Productos
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.PRODUCTOS (
...
-- Horarios
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.HORARIO_DIAS (
	HORARIO_DIA_ID DECIMAL(18,0) IDENTITY PRIMARY KEY,
	HORARIO_LOCAL_DIA NVARCHAR(50)
);

CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.HORARIOS (
...
-- Localidades
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.LOCALIDADES (
...
-- Dirección
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.DIRECCION (
...
-- Provincias
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.PROVINCIAS (
    PROVINCIA_ID DECIMAL(18,0) IDENTITY PRIMARY KEY,
    PROVINCIA_NOMBRE NVARCHAR(255)
);

-- Repartidores
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.REPARTIDORES (
...
-- Movilidad
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.MOVILIDAD (
    MOVILIDAD_ID DECIMAL(18,0) IDENTITY PRIMARY KEY,
    MOVILIDAD_TIPO NVARCHAR(50)
);

-- Pedidos
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.PEDIDOS(
...
-- Envío pedido
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.ENVIO_PEDIDO (
...
-- Estado pedido
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.ESTADO_PEDIDO (
    ESTADO_PEDIDO_ID DECIMAL(18,0) IDENTITY PRIMARY KEY,
    ESTADO_PEDIDO_NOMBRE NVARCHAR(50)
);

-- Medios de pago
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.MEDIOS_DE_PAGO (
...
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.TIPO_MEDIO_DE_PAGO (
    TIPO_MEDIO_PAGO_ID DECIMAL(18,0) IDENTITY PRIMARY KEY,
    TMP_TIPO NVARCHAR(50)
);

CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.MARCAS_TARJETA (
    MARCA_TARJETA_ID DECIMAL(18,0) IDENTITY PRIMARY KEY,
    MARCA_TARJETA_NOMBRE NVARCHAR(100)
);

-- Reclamos
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.RECLAMOS (
...
-- Usuarios
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.USUARIOS (
...
-- Dirección usuario
CREATE TABLE IF NOT EXISTS BASE_DE_GATOS_2.DIRECCION_USUARIO (
