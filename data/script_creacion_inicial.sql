...
-- Envio pedido
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_envio_pedidos
	AS
		BEGIN
	...
	AS
		...
		INSERT INTO BASE_DE_GATOS_2.PEDIDOS(
			...
			SELECT DISTINCT
				...
				mdp.MP_ID,
				SELECT (
					SELECT TOP 1 ep.EP_ID
					FROM BASE_DE_GATOS_2.ENVIO_PEDIDO ep
					WHERE ep.EP_PRECIO = m.PEDIDO_PRECIO_ENVIO
						AND ep.EP_PROPINA = m.PEDIDO_PROPINA
				)
			FROM
				gd_esquema.Maestra m
					JOIN BASE_DE_GATOS_2.TIPO_MEDIO_DE_PAGO tmp
...
CREATE PROCEDURE BASE_DE_GATOS_2.migrar_local_producto_pedido
	AS
		BEGIN
...
EXEC BASE_DE_GATOS_2.migrar_envio_pedidos
...
EXEC BASE_DE_GATOS_2.migrar_local_producto_pedido
