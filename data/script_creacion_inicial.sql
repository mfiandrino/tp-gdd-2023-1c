	...
	AS
		...
		INSERT INTO BASE_DE_GATOS_2.DIRECCION(DIRECCION_DIRECCION, LOCALIDAD_ID)
			SELECT DISTINCT 
				...
				l.LOCALIDAD_ID
			FROM gd_esquema.Maestra m
				JOIN BASE_DE_GATOS_2.LOCALIDADES l ON m.ENVIO_MENSAJERIA_LOCALIDAD = l.LOCALIDAD_NOMBRE
			...
			SELECT DISTINCT 
				...
				l.LOCALIDAD_ID
			FROM gd_esquema.Maestra m
				JOIN BASE_DE_GATOS_2.LOCALIDADES l ON m.DIRECCION_USUARIO_LOCALIDAD = l.LOCALIDAD_NOMBRE
			...
			SELECT DISTINCT 
				...
				l.LOCALIDAD_ID
			FROM gd_esquema.Maestra m
				JOIN BASE_DE_GATOS_2.LOCALIDADES l ON m.LOCAL_LOCALIDAD = l.LOCALIDAD_NOMBRE;
		END
GO
